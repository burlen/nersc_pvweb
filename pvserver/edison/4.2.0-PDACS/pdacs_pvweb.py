...
class _FileOpener(pv_wamp.PVServerProtocol):
    ...
    def openFile(self, files):
        ...
        try:
            ...
            _FileOpener.view.CenterOfRotation = [63.999996662139893, 63.999996185302734, 63.999996185302734]

            Calculator1 = simple.Calculator()

            _FileOpener.view.CameraPosition = [63.999996662139893, 63.999996185302734, 492.29631710692331]
            _FileOpener.view.CameraFocalPoint = [63.999996662139893, 63.999996185302734, 63.999996185302734]
            _FileOpener.view.CameraClippingRange = [296.65336530365192, 595.04075617962826]
            ...
            _FileOpener.view.Representations.append(ScalarBarWidgetRepresentation1)
