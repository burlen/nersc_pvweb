...
# =============================================================================
# Do any custom processing needed for pdacs
# =============================================================================
...
class _VisualizerServer(pv_wamp.PVServerProtocol):
    ...
    def configure(args):
        ...
        _VisualizerServer.pdacsFile    = None
        _VisualizerServer.fileToLoad   = None
        ...
        if args.file:
            ...
            if os.path.exists(file_name):
                if ext == '.gio':
                    # pdacs dataset
                    _VisualizerServer.pdacsFile = file_name
                else:
                    _VisualizerServer.fileToLoad = file_name
